        ...
        <div className="mb-10">
            <section className="flex flex-col lg:flex-row justify-between items-center lg:-mb-10 lg:mt-0 gap-5">
                ...
                <div className="flex gap-5 -mt-5">
                    ...
                    <AppButton href={`${userCanCreateANewHabit ? '/create-habit' : ''}`} className="mx-5 lg:px-10" disabled={!userCanCreateANewHabit}>
                        <div className="flex items-center justify-center gap-1 h-full w-52">
